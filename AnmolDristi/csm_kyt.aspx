<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="csm_kyt.aspx.cs" Inherits="AnmolDristi.csm_kyt" %>
                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit Report" CssClass="btn btn-primary" OnClick="SubmitKYTReport" />
                            </div>
