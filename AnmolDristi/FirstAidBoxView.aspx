<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="FirstAidBoxView.aspx.cs" Inherits="AnmolDristi.FirstAidBoxView" %>
    ...
    <div class="container">
        <div class="page-title">
            <div class="title_left">
                <h3>First Aid Box Checklist View
                </h3>
            </div>
        </div>
...
<div class="table-responsive">
    <div class="col-md-12">
        <div class="mb-3">
            <asp:GridView ID="gvChecklist" runat="server" AutoGenerateColumns="False" DataKeyNames="InspectionID" CssClass="table table-bordered table-sm table-hover table-striped nowrap" GridLines="None">
