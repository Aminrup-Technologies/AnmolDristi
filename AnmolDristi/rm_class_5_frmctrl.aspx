<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="rm_class_5_frmctrl.aspx.cs" Inherits="AnmolDristi.rm_class_5_frmctrl" %>
           ...
           <div class="row">
               <div class="col-md-12 col-sm-12 ">
                   <div class="x_panel">
                       <div class="x_title">
                           <h2>
                               <asp:Label ID="lbl_docnumber" runat="server" Text="QC RM Class 5 Report : Input Controller"></asp:Label></h2>
