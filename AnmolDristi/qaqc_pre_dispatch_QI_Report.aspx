                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_CBB_Produced" runat="server" ErrorMessage="*" ValidationGroup="Submit" ControlToValidate="TXT_CBB_Produced" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:RangeValidator ID="RV_CBB_Produced" runat="server" ControlToValidate="TXT_CBB_Produced" ErrorMessage="[15 - 40]" ForeColor="Red" MinimumValue="15" MaximumValue="40" Type="Integer" Display="Static"></asp:RangeValidator>
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TXT_CBB_Produced" runat="server" CssClass="form-control form-control-sm rounded" Placeholder="Number of CBB Produced [30 - 40]"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_CBB_Checked" runat="server" ErrorMessage="*" ValidationGroup="Submit" ControlToValidate="TXT_CBB_Checked" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:RangeValidator ID="RV_CBB_Checked" runat="server" ControlToValidate="TXT_CBB_Checked" ErrorMessage="[15 - 40]" ForeColor="Red" MinimumValue="15" MaximumValue="40" Type="Integer" Display="Static"></asp:RangeValidator>
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TXT_CBB_Checked" runat="server" CssClass="form-control form-control-sm rounded" Placeholder="Number of CBB Checked [30 - 40]"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_BoxCondition" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_BoxCondition" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="BoxConditionRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    <asp:Label ID="LabelBoxConditionRemarks" runat="server" AssociatedControlID="TXB_BoxCondition_Remarks" Text="Box Condition (Not Ok)" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    <asp:RequiredFieldValidator ID="RFV_BoxConditionRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_BoxCondition_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_Packets_CBB" runat="server" ErrorMessage="*" ValidationGroup="Submit" ControlToValidate="TXT_Packets_CBB" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:RangeValidator ID="RV_Packets_CBB" runat="server" ControlToValidate="TXT_Packets_CBB" ErrorMessage="[15 - 40]" ForeColor="Red" MinimumValue="15" MaximumValue="40" Type="Integer" Display="Static"></asp:RangeValidator>
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TXT_Packets_CBB" runat="server" CssClass="form-control form-control-sm rounded" Placeholder="Number of Packets in CBB [15 - 40]"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_Tapping" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_Tapping" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="TappingRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_TappingRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_Tapping_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <asp:Label ID="lblPkts_Checked_Per_CBB" runat="server" AssociatedControlID="TXT_Pkts_Checked_Per_CBB" Text="No. of PKTS Checked Per CBB Box:" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    <asp:RequiredFieldValidator ID="RFV_Pkts_Checked_Per_CBB" runat="server" ErrorMessage="*" ValidationGroup="Submit" ControlToValidate="TXT_Pkts_Checked_Per_CBB" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:RangeValidator ID="RV_Pkts_Checked_Per_CBB" runat="server" ControlToValidate="TXT_Pkts_Checked_Per_CBB" ErrorMessage="[15 - 40]" ForeColor="Red" MinimumValue="15" MaximumValue="40" Type="Integer" Display="Static"></asp:RangeValidator>
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TXT_Pkts_Checked_Per_CBB" runat="server" CssClass="form-control form-control-sm rounded" Placeholder="Number of PKTS Checked Per CBB Box [15 - 40]"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_Wt_of_Pkts" runat="server" ErrorMessage="*" ValidationGroup="Submit" ControlToValidate="TXT_Wt_of_Pkts" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:RangeValidator ID="RV_Wt_of_Pkts" runat="server" ControlToValidate="TXT_Wt_of_Pkts" ErrorMessage="[0.01 - 50.00 kg]" ForeColor="Red" MinimumValue="0.01" MaximumValue="50.00" Type="Double" Display="Static"></asp:RangeValidator>
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TXT_Wt_of_Pkts" runat="server" CssClass="form-control form-control-sm rounded" Placeholder="Weight of Pkts in kg [0.01 - 50.00]"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TXT_BatchNo" runat="server" CssClass="form-control form-control-sm rounded" Placeholder="Enter Batch/Lot No"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_PacketsMRP" runat="server" ErrorMessage="*" ValidationGroup="Submit" ControlToValidate="TXT_PacketsMRP" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="REF_PacketsMRP" runat="server" ValidationGroup="Submit" ControlToValidate="TXT_PacketsMRP" ForeColor="Red" ErrorMessage="Decimal Only" ValidationExpression="^\d*\.\d{1,2}$" Display="Dynamic"></asp:RegularExpressionValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_LongSeal" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_LongSeal" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="LongSealRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_LongSealRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_LongSeal_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_EndSeal" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_EndSeal" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="EndSealRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_EndSealRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_EndSeal_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <asp:Label ID="LabelMainPanel" runat="server" AssociatedControlID="RBL_MainPanel" Text="Main Panel Central or Not :" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    <asp:RequiredFieldValidator ID="RFV_RBL_MainPanel" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_MainPanel" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="MainPanelRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_MainPanelRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_MainPanel_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_CutsPackets" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_CutsPackets" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="CutsPacketsRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_CutsPacketsRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_CutsPackets_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <asp:Label ID="LabelBackingStatus" runat="server" AssociatedControlID="RBL_BackingStatus" Text="Baking of Biscuits (Under/Over Baked) :" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    <asp:RequiredFieldValidator ID="RFV_RBL_BackingStatus" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_BackingStatus" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="BackingStatusRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_BackingStatusRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_BackingStatus_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_ElongOval" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_ElongOval" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="ElongOvalRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_ElongOvalRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_ElongOval_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_Cupping" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_Cupping" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="CuppingRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_CuppingRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_Cupping_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_Impression" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_Impression" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="ImpressionRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_ImpressionRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_Impression_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_SoggyStatus" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_SoggyStatus" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="SoggyStatusRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_SoggyStatusRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_SoggyStatus_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_ForeignBody" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_ForeignBody" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="ForeignBodyRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_ForeignBodyRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_ForeignBody_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_RBL_OffOdour" runat="server" ValidationGroup="Submit" ErrorMessage="*" ForeColor="Red" ControlToValidate="RBL_OffOdour" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3" id="OffOdourRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_OffOdourRemarks" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TXB_OffOdour_Remarks" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TXB_Remarks" runat="server" CssClass="form-control form-control-sm rounded" TextMode="MultiLine" Rows="4" Width="100%"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
