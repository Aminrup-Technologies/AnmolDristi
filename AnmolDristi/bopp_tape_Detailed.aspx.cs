...
{
    public partial class bopp_tape_Detailed : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (source == "submitter")
                {
                    ...
                    BtnBack.PostBackUrl = "~/bopp_tape_View.aspx";
                    Lbl_BasicbtnApprove.Text = "Click on your Action";
                }
                else
                {
                    BtnBack.PostBackUrl = "~/bopp_tape_approval.aspx";
                }
            }
        }
        ...
        void getDetails(DataTable dt)
        {
            if (dt.Rows.Count > 0)
            {
                ...
                TB_PrintingColour.Text = dt.Rows[0]["PrintingColour"].ToString();
                TB_AdhesiveProperty.Text = dt.Rows[0]["AdhesiveProperty"].ToString();
