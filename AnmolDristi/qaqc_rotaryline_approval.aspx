                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText=" Approvals Details">
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <asp:Button ID="ApproveBtn" runat="server" Text="Approve" CssClass="btn btn-warning btn-sm" CausesValidation="false" CommandArgument='<%# Eval("ID") %>' OnClick="ApproveBtn_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
