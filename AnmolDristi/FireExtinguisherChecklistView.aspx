<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="FireExtinguisherChecklistView.aspx.cs" Inherits="AnmolDristi.FireExtinguisherChecklistView" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Fire Extinguisher Checklist View</h2>
...
<div class="table-responsive">
    <div class="col-md-12">
        <div class="mb-3">
            <asp:GridView ID="gvChecklist" runat="server" AutoGenerateColumns="False" DataKeyNames="HeaderID" CssClass="table table-bordered table-sm table-hover table-striped nowrap" GridLines="None">
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                             <asp:Button ID="BtnEdit" runat="server" Text="Edit" CssClass="btn btn-warning btn-sm" CommandArgument='<%# Eval("HeaderID") %>' OnClick="BtnEdit_Click" />
                            <asp:Button ID="Btndelete" runat="server" Text="Delete" CssClass="btn btn-danger btn-sm" OnClick="Btndelete_Click" OnClientClick="return confirm('Are you sure you want to delete?');" />
                             <asp:Button ID="btnView" runat="server" Text="View" CssClass="btn btn-primary btn-sm" CommandArgument='<%# Eval("HeaderID") %>' OnClick="btnView_Click" />
                            </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
