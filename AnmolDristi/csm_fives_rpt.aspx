...
<head runat="server">
    <title>CSM | Five S Audit Report</title>
    <style type="text/css">
        @media print {
            @page {
                size: A4;
                ...
                <tr>
                    <td>
                        <table class="question">
                            ...
                            <%-- question--%>
                            <tr>
                                <td><asp:Label ID="lbl_1" runat="server" Text="is this floor area free of unwanted items?" Font-Bold="false" Font-Size="Small"></asp:Label></td>
                                <td>✅</td>
                                <td></td>
                            </tr>
                            <tr>
