...
{
    public partial class RM_Class_1_Report : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("RM_Class_1_Report.aspx");
        }
        ...
        //            // Execute the stored procedure and get the result into a SqlDataReader
        //            using (SqlDataReader reader = cmd.ExecuteReader())
        //            {
        ...
        //                    // Loop through each column to check if it contains data
        //                    foreach (DataColumn column in dt.Columns)
        //                    {
        //                        // Check if all rows for this column are null or empty
        //                        bool columnHasData = dt.AsEnumerable().Any(row =>
        //                        {
        ...
        //                        // If the column has no data, mark it for removal
        //                        if (!columnHasData)
        //                        {
        ...
        //                    // Remove the columns that have no data
        ...
        //protected void ExportBtn_Click(object sender, EventArgs e)
        //{
        //    // Assuming GridView1 is the GridView or any data source control displaying the data
        ...
        //        // Add Column Headers from GridView
        //        for (int i = 0; i < GridView1.HeaderRow.Cells.Count; i++)
        //        {
        //            worksheet.Cells[1, i + 1] = GridView1.HeaderRow.Cells[i].Text; // Adding column headers
        //        }
        ...
        //            {
        //                worksheet.Cells[rowIndex, i + 1] = row.Cells[i].Text; // Add data to the cells
        //            }
        //            rowIndex++;
        //        }
