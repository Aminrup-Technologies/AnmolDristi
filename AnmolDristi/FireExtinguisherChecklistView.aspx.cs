...
{
    public partial class FireExtinguisherChecklistView : System.Web.UI.Page
    {
        ...
        protected void Btndelete_Click(object sender, EventArgs e)
        {
           ...
           // int headerID = Convert.ToInt32(gvChecklist.DataKeys[row.RowIndex].Value);
            ...
            using (SqlConnection con = new SqlConnection(connStr))
            {
                ...
                SqlCommand deleteChecklistCmd = new SqlCommand("DELETE FROM FireExtinguisherChecklist WHERE HeaderID = @HeaderID", con);
                ...
                SqlCommand deleteHeaderCmd = new SqlCommand("DELETE FROM FireExtinguisherHeader WHERE HeaderID = @HeaderID", con);
        ...
        protected void Btnsearch_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string query = @"SELECT HeaderID,ChecklistDate,JobID,Location,EmployeeName,InspectedBy  from  FireExtinguisherHeader where ChecklistDate BETWEEN @FromDate AND @ToDate ORDER BY ChecklistDate DESC";
