...
{
    public partial class vm_overwrap : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    lbl_docname.Text = "Search Filter for QC HM Bag/ PP Bag Report";
        ...
        {
            Response.Redirect("vm_overwrap.aspx");
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "View")
            {
                ...
                if (dbid > 0)
                {
                    ...
                    Response.Redirect("overwrap_Detailed.aspx?DBID=" + dbid + "&source=report");
                }
                else
                {
