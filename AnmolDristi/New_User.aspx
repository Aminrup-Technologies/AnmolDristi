<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="New_User.aspx.cs" Inherits="AnmolDristi.New_User" %>
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Region" Enabled="false" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="true" ValidationGroup="Submit" OnSelectedIndexChanged="DDL_Region_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
