<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="New_User.aspx.cs" Inherits="AnmolDristi.New_User" Async="true"%>
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Company" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="true" ValidationGroup="Submit" OnSelectedIndexChanged="DDL_Company_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Region" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="true" ValidationGroup="Submit" OnSelectedIndexChanged="DDL_Region_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Branch" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="true" ValidationGroup="Submit" OnSelectedIndexChanged="DDL_Branch_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <asp:Label ID="Lbl_DDL_Division" runat="server" AssociatedControlID="DDL_Division" Text="Region  " ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    ...
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Division" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="true" ValidationGroup="Submit" OnSelectedIndexChanged="DDL_Division_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Category" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="true" ValidationGroup="Submit" OnSelectedIndexChanged="DDL_Category_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Grade" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="true" ValidationGroup="Submit" OnSelectedIndexChanged="DDL_Grade_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
...
<%--                                    <asp:RequiredFieldValidator ID="RFV_TB_Mobile" runat="server" ErrorMessage="Mobile is required " ControlToValidate="TB_Mobile" InitialValue="" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                    <asp:RegularExpressionValidator ID="REV_TB_Mobile" runat="server" ControlToValidate="TB_Mobile" ForeColor="Red"  ErrorMessage="Not correct format (no. should start from 6-9)" ValidationExpression="^[6-9][0-9]{9}$" Display="Dynamic"></asp:RegularExpressionValidator>
                                    <div class="input-group-sm">
