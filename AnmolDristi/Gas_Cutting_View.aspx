...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Checklist Question">
            ...
            <EditItemTemplate>
                <asp:Label ID="txtChecklistQuestion" runat="server" Text='<%# Bind("ChecklistQuestion") %>' ReadOnly="true" />
            </EditItemTemplate>
        </asp:TemplateField>
...
<asp:TemplateField HeaderText="Gas Cutter Name">
    ...
    <EditItemTemplate>
        ...
        <asp:TemplateField HeaderText="Actions">
            <ItemTemplate>
                <asp:LinkButton ID="btnView" runat="server" Text="View" CssClass="btn btn-info btn-actions btn-sm" CommandArgument='<%# Eval("HeaderID") %>' OnClick="btnView_Click"></asp:LinkButton>
