...
{
    public partial class aata_maida_frmctrl : System.Web.UI.Page
    {
        ...
        protected void btn_insert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = InsertQCAataMaidaRpt_BrandFieldsControl(material_Id, materialName, brand_Id, brandName);
        ...
        public int InsertQCAataMaidaRpt_BrandFieldsControl(int materialId, string materialName, int brandId, string brandName)
        {
            string connStr = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                using (SqlCommand cmd = new SqlCommand("dbo.InsertQCAataMaidaRpt_BrandFieldsControl", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
