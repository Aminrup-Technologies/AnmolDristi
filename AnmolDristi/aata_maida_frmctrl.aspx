<%@ Page Title="AIL | QC Aata Maida Controller" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="aata_maida_frmctrl.aspx.cs" Inherits="AnmolDristi.aata_maida_frmctrl" %>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <asp:Label ID="lbl_docnumber" runat="server" Text="QC Aata and Maida Report : Input Controller"></asp:Label></h2>
