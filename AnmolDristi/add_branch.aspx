<%@ Page Title="AIL | Manage Branch" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="add_branch.aspx.cs" Inherits="AnmolDristi.add_branch" %>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <asp:Label ID="Lbl_Branch_Description" runat="server" AssociatedControlID="TB_Branch_Description" Text="Branch Description :" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                        <asp:RequiredFieldValidator ID="RFV_Branch_Description" runat="server" ErrorMessage="*" ControlToValidate="TB_Branch_Description" ValidationGroup="Submit" InitialValue="" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="REV_Branch_Description" runat="server" ControlToValidate="TB_Branch_Description" ForeColor="Red" ValidationGroup="Submit" ErrorMessage="Alphanumeric Only" ValidationExpression="^[a-zA-Z0-9\s]*$" Display="Dynamic"></asp:RegularExpressionValidator>
                                        <div class="input-group-sm">
                                            <asp:TextBox ID="TB_Branch_Description" runat="server" CssClass="form-control form-control-sm rounded" Placeholder="Branch Description (3-50 characters)" MaxLength="50"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="x_content">
                                <div class="row">
                                    <div class="card-box col-md-12 col-sm-12" style="width: 100%; height: 450px; overflow: scroll;">
                                        <asp:GridView ID="GridViewBranches" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                                            ...
                                            OnRowEditing="GridViewBranches_RowEditing"
