...

        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    // SQL Insert Query
                    string query = @"INSERT INTO TRN_PVC_Tray (PVCID, PlantName, ProductBrand, Supplier_Name, Challan_No, Challan_Date, Lot_No, Vehicle_No, Dimension_Obs_L, Dimension_Obs_W, Dimension_Obs_H, GSM_Obs, Remarks, SubmittedById, SubmittedByEmployeeCode, SubmittedDate, SubmittedTime) VALUES 
                      (@PVCID, @PlantName, @ProductBrand, @Supplier_Name, @Challan_No, @Challan_Date, @Lot_No, @Vehicle_No, @Dimension_Obs_L, @Dimension_Obs_W, @Dimension_Obs_H, @GSM_Obs, @Remarks, @SubmittedById, @SubmittedByEmployeeCode, @SubmittedDate, @SubmittedTime)";
