                ...
                <div class="col-md-12 col-sm-12  ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <asp:GridView ID="View" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-responsive-md">

                                <HeaderStyle CssClass="thead-dark" />
                                <Columns>
                                    <asp:BoundField DataField="ID" HeaderText="Line Walk ID" ReadOnly="true" />
                                    <asp:BoundField DataField="WalkDate" HeaderText="Date" />
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <asp:HyperLink ID="btnView" runat="server" CssClass="btn btn-info text-white m-2" >
                                                           <i class="fa fa-eye"></i> View </asp:HyperLink>
                                                
                                                <asp:HyperLink ID="btnEdit" runat="server" CssClass="btn btn-warning text-white m-2" >     
                                                           <i class="fa fa-edit"></i> Edit</asp:HyperLink>
                                                
                                                <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-danger text-white m-2">
