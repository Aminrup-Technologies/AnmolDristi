<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="CapaView.aspx.cs" Inherits="AnmolDristi.JCCCapaView" %>
        ...
        <div class="capa-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <asp:TextBox ID="phototxtbox" runat="server" CssClass="form-control mb-2" ReadOnly="true"></asp:TextBox>
                    <asp:Image ID="imgtxtbox" runat="server" CssClass="capa-img-preview" ImageUrl="https://cdn-icons-png.flaticon.com/512/4218/4218934.png" />
                </div>
            </div>
        </div>
