<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="RM_Class_1_Report.aspx.cs" Inherits="AnmolDristi.RM_Class_1_Report" %>
                                    ...
                                    <div class="x-content">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="RFV_DDL_Material" runat="server" ErrorMessage="" ForeColor="Red" ControlToValidate="DDL_Material" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
                                                <div class="input-group-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="RFV_DDL_ProductCategory" runat="server" ErrorMessage="" ForeColor="Red" InitialValue="0" ControlToValidate="DDL_ProductCategory" Display="Dynamic"></asp:RequiredFieldValidator>
                                                <div class="input-group-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="RFV_DDL_ProductBrand" runat="server" ErrorMessage="" ForeColor="Red" ControlToValidate="DDL_ProductBrand" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
                                                <div class="input-group-sm">
                    ...
                    <div class="x_panel">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="table table-striped table-hover table-bordered table-responsive table-sm table-condensed text-wrap" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Material Details" HeaderStyle-Width="20%">
                                    <ItemTemplate>
                                        Material Name:<asp:Label ID="lbl_MaterialName" runat="server" Text='<%# Eval("MaterialName") %>' Font-Bold="true" /><br />
                                    </ItemTemplate>
                                </asp:TemplateField>
