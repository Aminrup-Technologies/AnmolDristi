...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Employee Entry Form -->
<div class="col-lg-12 mb-3 border rounded p-3 bg-light">
    <!-- Row 1: Employee ID, Name, Designation -->
    <div class="row g-2 mb-3">
        <div class="col-md-4">
            <asp:Label ID="lblEmployeeID" runat="server" Text="Employee ID" ForeColor="Blue" Font-Bold="true" Font-Size="Small" />
            <asp:TextBox ID="txtEmployeeID" runat="server" CssClass="form-control form-control-sm" Placeholder="Enter Employee ID" />
        </div>
        <div class="col-md-4">
            <asp:Label ID="lblEmployeeName" runat="server" Text="Employee Name" ForeColor="Blue" Font-Bold="true" Font-Size="Small" />
            <asp:TextBox ID="txtEmployeeName" runat="server" CssClass="form-control form-control-sm" Placeholder="Enter Employee Name" />
        </div>
        <div class="col-md-4">
            <asp:Label ID="lblDesignation" runat="server" Text="Designation" ForeColor="Blue" Font-Bold="true" Font-Size="Small" />
            <asp:TextBox ID="txtDesignation" runat="server" CssClass="form-control form-control-sm" Placeholder="Enter Designation" />
        </div>
    </div>

    <!-- Row 2: Award Category and Photo Upload -->
<div class="row g-2 mb-3">
    <div class="col-md-5">
        <asp:Label ID="lblAwardCategory" runat="server" Text="Award Category" ForeColor="Blue" Font-Bold="true" Font-Size="Small" />
        <asp:DropDownList ID="ddlAwardCategory" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="false">
            <asp:ListItem Text="--Select Award Category--" Value="-1" />
        </asp:DropDownList>
        <asp:RequiredFieldValidator ID="rfvAwardCategory" runat="server" 
            ValidationGroup="Awardee" ControlToValidate="ddlAwardCategory" 
            InitialValue="-1" ErrorMessage="Select Award Category." 
            ForeColor="Red" Display="Dynamic" />
    </div>

    <div class="col-md-4">
        <asp:Label ID="lblPhoto" runat="server" Text="Upload Photo" ForeColor="Blue" Font-Bold="true" Font-Size="Small" />
        <asp:FileUpload ID="fuPhoto" runat="server" CssClass="form-control form-control-sm file-upload" />
    </div>
</div>

<!-- Row 3: Add Button Centered -->
<div class="row">
    <div class="col-md-12 text-center">
        <asp:Button ID="BtnAddEmployee" runat="server" Text="Add More" CssClass="btn btn-success btn-sm" OnClick="BtnAddEmployee_Click" />
    </div>
</div>
    ...
    <div class="col-lg-12 mt-2">
        <asp:GridView ID="GvEmployees" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm text-center">
            <Columns>
                <asp:BoundField DataField="EmployeeID" HeaderText="Employee ID" />
                <asp:BoundField DataField="EmployeeName" HeaderText="Employee Name" />
                <asp:BoundField DataField="Designation" HeaderText="Designation" />
                <asp:BoundField DataField="AwardCategory" HeaderText="Award Category" />
                <asp:BoundField DataField="PhotoName" HeaderText="Photo" />
            </Columns>
        </asp:GridView>
    </div>
