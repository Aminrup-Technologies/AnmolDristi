...
{
    public partial class rm_class_3_frmctrl : System.Web.UI.Page
    {
        ...
        protected void btn_insert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = InsertQCRMClass3Rpt_BrandFieldsControl(material_Id, materialName, plant_Id, plantName);
        ...
        public int InsertQCRMClass3Rpt_BrandFieldsControl(int materialId, string materialName, int plantId, string plantName)
        {
            string connStr = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            using (SqlConnection conn = new SqlConnection(connStr))
            {
