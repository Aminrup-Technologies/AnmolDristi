...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var storedValue = localStorage.getItem("AppStatusValue");
            if (storedValue) {
                var radioToSelect = document.querySelector('input[name="RBL_AppStatus"][value="' + storedValue + '"]');
                if (radioToSelect) {
                    radioToSelect.checked = true;
                    toggleAppStatusRemarksDiv(); // Ensure the correct UI state
                }
            }
        };
