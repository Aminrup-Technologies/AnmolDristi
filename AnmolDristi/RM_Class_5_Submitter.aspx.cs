...
{
    public partial class RM_Class_5_Submitter : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    lbl_docname.Text = "Search Filter for QC RM Class 5 Report";
        ...
        {
            Response.Redirect("RM_Class_5_Submitter.aspx");
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "View")
            {
                ...
                if (id > 0)
                {
                    ...
                    Response.Redirect("RM_Class_5_Detailed.aspx?Id=" + id + "&source=submitter");
                }
                else
                {
