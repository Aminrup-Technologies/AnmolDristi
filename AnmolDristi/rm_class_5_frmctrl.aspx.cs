...
{
    public partial class rm_class_5_frmctrl : System.Web.UI.Page
    {
        ...
        protected void btn_insert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = InsertQCRMClass5Rpt_BrandFieldsControl(material_Id, materialName, plant_Id, plantName);
        ...
        public int InsertQCRMClass5Rpt_BrandFieldsControl(int materialId, string materialName, int plantId, string plantName)
        {
            string connStr = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            using (SqlConnection conn = new SqlConnection(connStr))
            {
