<%@ Page Title="AIL | QC RM Class 4 Controller" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="rm_class_4_frmctrl.aspx.cs" Inherits="AnmolDristi.rm_class_4_frmctrl" %>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            <asp:Label ID="lbl_docnumber" runat="server" Text="QC RM Class 4 Report : Input Controller"></asp:Label></h2>
