...
{
    public partial class CorrugatedBoardBox_Approval : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("CorrugatedBoardBox_Approval.aspx");
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "View")
            {
                ...
                if (dbid > 0)
                {
                    ...
                    Response.Redirect("CorrugatedBoardBox_Detailed.aspx?DBID=" + dbid);
                }
                else
                {
