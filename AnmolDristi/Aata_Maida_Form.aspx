<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="Aata_Maida_Form.aspx.cs" Inherits="AnmolDristi.Aata_Maida_Form" %>
                        ...
                        <div class="x-content">
                            ...
                            <div class="col-md-3" id="SizeDIV" runat="server">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TB_Size" runat="server" CssClass="form-control form-control-sm rounded" ValidationGroup="Submit" Placeholder="Size(in mm)" ></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3" id="MfgDIV" runat="server">
                                <div class="mb-3">
                                    <asp:Label ID="Lbl_TB_Mfg" runat="server" AssociatedControlID="TB_Mfg" Text=" Mfg :" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                            ...
                            <div class="col-md-3" id="GrittinessRemarksDiv" style="display: none;">
                                <div class="mb-3">
                                    <asp:Label ID="LabelGrittinessRemarks" runat="server" AssociatedControlID="TXB_Grittiness_Remarks" Text="Grittiness (Negative)" ForeColor="Red" Font-Bold="true" Font-Size="Small"></asp:Label>
