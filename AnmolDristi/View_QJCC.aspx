                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <div class="table-responsive-custom">
                                <h4 class="text-white bg-success p-2 rounded fw-bold fs-4 text-center sticky-header " style="font-size: 20px; font-weight: bold; font-family:'Times New Roman', Times, serif"; width="100%">Basic Details</h4>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <asp:Label runat="server" ID="oknotok" Text='<%# Eval("Result") %>' /><br />
                                                                        <asp:HyperLink runat="server" ID="lnkCapa" ForeColor="Black" ToolTip="View CAPA Details" /></td>
                                                                    <td><%# Eval("Remark") %></td>
                                                                     <td style="text-align:center">
