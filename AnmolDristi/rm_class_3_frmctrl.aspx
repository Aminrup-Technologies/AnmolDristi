<%@ Page Title="AIL | QC RM Class 3 Controller" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="rm_class_3_frmctrl.aspx.cs" Inherits="AnmolDristi.rm_class_3_frmctrl" %>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <asp:Label ID="lbl_docnumber" runat="server" Text="QC RM Class 3 Report : Input Controller"></asp:Label></h2>
                        ...
                        <div class="x_content">
                           ...
                           <asp:RequiredFieldValidator ID="RFV_DDL_Material" runat="server" ErrorMessage="*" ForeColor="Red" ValidationGroup="Submit" InitialValue="" ControlToValidate="DDL_Material" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                                        <asp:DropDownList ID="DDL_Material" runat="server" CssClass="form-control form-control-sm rounded"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="input-group-sm">
                               <asp:DropDownList ID="DDL_Plant" runat="server" CssClass="form-control form-control-sm rounded" AutoPostBack="false" ValidationGroup="Submit"></asp:DropDownList>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" Width="100%" class="table table-striped table-hover table-bordered table-responsive table-sm table-condensed" Font-Size="8" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" DataKeyNames="Id">
                                        <Columns>
                                          ...
                                          <asp:BoundField DataField="brand_name" HeaderText="Brand Name" Visible="false" ReadOnly="True" HeaderStyle-Width="5%" ItemStyle-Width="5%" />--%>
                                            ...
                                            <asp:TemplateField HeaderText="UI Display Name" HeaderStyle-Width="5%" ItemStyle-Width="15%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDisplayName" runat="server" Text='<%# Eval("DisplayName") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtDisplayName" runat="server" Text='<%# Eval("DisplayName") %>' Width="100%"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="RFV Error Msg" HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtRFVErrorMsg" runat="server" Text='<%# Eval("RFV_ErrorMsg") %>' Width="100%"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="REV Error Msg" HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtREVErrorMsg" runat="server" Text='<%# Eval("REV_ErrorMsg") %>' Width="100%"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="REV Expression" HeaderStyle-Width="10%" ItemStyle-Width="15%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblREVExpression" runat="server" Text='<%# Eval("REV_Expression") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtREVExpression" runat="server" Text='<%# Eval("REV_Expression") %>' Width="100%"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="RV ErrorMsg" HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtRVErrorMsg" runat="server" Text='<%# Eval("RV_ErrorMsg") %>' Width="100%"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="RV MinValue" HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtRVMinValue" runat="server" Text='<%# Eval("RV_MinValue") %>' Width="100%"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="RV MaxValue" HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtRVMaxValue" runat="server" Text='<%# Eval("RV_MaxValue") %>' Width="100%"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
