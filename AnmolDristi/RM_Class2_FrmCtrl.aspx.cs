...
{
    public partial class RM_Class2_FrmCtrl : System.Web.UI.Page
    {
        ...
        protected void btn_insert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = InsertQCRMClass2Rpt_MaterialFieldsControl(material_Id, materialName, plant_Id, plantName);
        ...
        public int InsertQCRMClass2Rpt_MaterialFieldsControl(int materialId, string materialName, int plantId, string plantName)
        {
            string connStr = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            using (SqlConnection conn = new SqlConnection(connStr))
            {
