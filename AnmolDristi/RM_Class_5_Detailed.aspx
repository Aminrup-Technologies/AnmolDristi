<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="RM_Class_5_Detailed.aspx.cs" Inherits="AnmolDristi.RM_Class_5_Detailed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validateAcidValue(sender, args) {
        ...
        function validateMpcpValue(sender, args) {
        ...
        function validateDispersabilityValue(sender, args) {
        ...
        function validateDrcValue(sender, args) {
        ...
        function validateMonoGlycerideContentValue(sender, args) {
        ...
        function validateNeutralizingValue(sender, args) {
                        ...
                        <div class="x-content">
                            ...
                            <div class="col-md-3" id="PkdMfgDIV" runat="server">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TB_PkdMfg" runat="server" CssClass="form-control form-control-sm rounded" ValidationGroup="Submit"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <asp:Button ID="BtnBack" runat="server" Text="Back" CssClass="btn btn-sm btn-info" CausesValidation="false" PostBackUrl="~/RM_Class_5_Approval.aspx" />
                                    </div>
                                </div>
                            </div>
