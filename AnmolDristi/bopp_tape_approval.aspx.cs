...
{
    public partial class bopp_tape_approval : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    lbl_docname.Text = "Search Filter for QC Adhesive Tape Report";
        ...
        {
            Response.Redirect("bopp_tape_approval.aspx");
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "View")
            {
                ...
                if (dbid > 0)
                {
                    ...
                    Response.Redirect("bopp_tape_Detailed.aspx?DBID=" + dbid);
                }
                else
                {
