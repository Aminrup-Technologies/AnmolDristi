...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function toggleAllRemarksTextboxVisibility() {
            ...
            var fields = [
                { obsId: '<%= TB_Length.ClientID %>', stdId: '<%= Literal_Std_Length.ClientID %>', remarksId: '<%= TXB_Length_Remarks.ClientID %>' },
                { obsId: '<%= TB_Width.ClientID %>', stdId: '<%= Literal_Std_Width.ClientID %>', remarksId: '<%= TXB_Width_Remarks.ClientID %>' },
                { obsId: '<%= TB_Height.ClientID %>', stdId: '<%= Literal_Std_Height.ClientID %>', remarksId: '<%= TXB_Height_Remarks.ClientID %>' },
                { obsId: '<%= TB_GSM.ClientID %>', stdId: '<%= Literal_Std_GSM.ClientID %>', remarksId: '<%= TXB_Height_Remarks.ClientID %>' }
            ];
        ...
        function toggleRemarksTextboxVisibility(obsId, stdId, remarksId) {
            ...
            var literalStd = document.getElementById(stdId);
            var tbRemarks = document.getElementById(remarksId);

            if (tbObs && literalStd && tbRemarks) {
                var observedValue = parseFloat(tbObs.value);
                var standardValue = parseFloat(literalStd.innerText);
                                                ...
                                                <div class="x-content">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <asp:Literal ID="Literal_Std_Length" runat="server" Text='<%# Eval("Std_Length") %>' EnableViewState="false"></asp:Literal>
                                                            <div class="input-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <asp:Literal ID="Literal_Std_Width" runat="server" Text='<%# Eval("Std_Width") %>' EnableViewState="false"></asp:Literal>
                                                            <div class="input-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group-sm">
                                                                <asp:Literal ID="Literal_Std_Height" runat="server" Text='<%# Eval("Std_Height") %>' EnableViewState="false"></asp:Literal>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <asp:Literal ID="Literal_Std_GSM" runat="server" Text=' <%# Eval("GMS_Std") %>' EnableViewState="false"></asp:Literal>
                                                            <div class="input-group-sm">
