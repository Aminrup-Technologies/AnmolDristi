...
{
    public partial class PM_Laminate_Approval : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("PM_Laminate_Approval.aspx");
        }
        ...
        protected void ApproveBtn_Click(object sender, EventArgs e)
        {
            ...
            string ltrid = btn.CommandArgument;

            // Redirect to the Process_FinalApproval.aspx page with the PcrNo in the query string
            Response.Redirect("PM_Laminate_FinalApproval.aspx?LTRID=" + ltrid);
        }
    }
}