<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="str_add_warehouse.aspx.cs" Inherits="AnmolDristi.str_add_warehouse" %>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="col-md-3">
                              ...
                              <div class="col-md-3">
                                <div class="mb-3">
                                    <asp:Label ID="LBL_TB_WarehouseName" runat="server" AssociatedControlID="TB_WarehouseName" Text="Enter Warehouse Name :" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    <asp:RequiredFieldValidator ID="RFV_TB_WarehouseName" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TB_WarehouseName" Display="Dynamic" InitialValue="" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TB_WarehouseName" runat="server" CssClass="form-control form-control-sm rounded"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <asp:Label ID="LBL_TB_WarehouseCode" runat="server" AssociatedControlID="TB_WarehouseCode" Text="Enter Warehouse Code :" ForeColor="Blue" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    <asp:RequiredFieldValidator ID="RFV_TB_WarehouseCode" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="TB_WarehouseCode" Display="Dynamic" InitialValue="" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                    <div class="input-group-sm">
                                        <asp:TextBox ID="TB_WarehouseCode" runat="server" CssClass="form-control form-control-sm rounded" ></asp:TextBox>
                                    </div>
