                                                ...
                                                <div class="x-content">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <asp:Literal ID="span_L" runat="server" Text='<%#  Eval("Dimension_Std_L") %>'></asp:Literal>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RFV_TB_Height" runat="server" ErrorMessage="Input Required" ControlToValidate="TB_Height" InitialValue="" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
