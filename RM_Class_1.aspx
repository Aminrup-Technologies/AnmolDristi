<%@ Page Title="" Language="C#" MasterPageFile="~/Dristi.Master" AutoEventWireup="true" CodeBehind="RM_Class_1.aspx.cs" Inherits="AnmolDristi.RM_Class_1" %>
                        ...
                        <div class="x-content">
                            ...
                            <div class="col-md-3" id="SupplierDIV" runat="server">
                                <div class="mb-3">
                                    ...
                                    <asp:RegularExpressionValidator ID="REV_TB_Supplier" runat="server" ControlToValidate="TB_Supplier" ValidationGroup="Submit" ForeColor="Red" ErrorMessage="Alphabet Only" ValidationExpression="^[a-zA-Z0-9]*$" Display="Dynamic"></asp:RegularExpressionValidator>
                                    <div class="input-group-sm">
